...
export type { Challenge, HumanVerifier, StepUpProof, VerifyOutcome, VerifyPlan, WorldPreset } from './types'
 ...
 */
export function humanVerifier(env: NodeJS.ProcessEnv = process.env): HumanVerifier {
